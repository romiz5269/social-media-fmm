...
function AddBlog() {
  ...
  return (
    <div>
      <button
        onClick={handleOpen}
        className="bg-gradient-to-r from-cyan-500 to-blue-500 font-Vazirmatn hidden lg:block md:hidden mt-2 py-4 px-[70px] text-sm font-semibold text-white rounded-full shadow-xl "
      >
        بلاگ جدید
      </button>
      <button
