...
function SuggestSingleUser() {
  return (
    <Link to="/user/mohammadreza">
      <div className="grid grid-cols-5 hover:bg-slate-100 dark:hover:bg-slate-800 py-5 pl-5">
        <div className="col-span-4 flex flex-row pr-3">
          ...
          />
          <span className="text-sm pr-3 pt-2 overflow-x-hidden text-ellipsis dark:text-white">
            MohammadReza
          </span>
        </div>
