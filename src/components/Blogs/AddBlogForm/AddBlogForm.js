...
function AddBlogForm() {
  ...
  return (
    <div className="flex flex-col pb-3 sm:pt-3" style={{borderTop:'1px solid #e7e7e7'}}>
        ...
        <div className="col-span-5 flex flex-col justify-evenly">
          <div className="grid grid-cols-5 justify-between">
            ...
            <div className="col-span-2 w-full flex flex-row justify-center">
                <button className="text-sm bg-blue-500 disabled:bg-slate-300 font-Vazirmatn  text-white  px-8 py-2 rounded-xl shadow-xl">
                  انتشار
                </button>
            </div>
          </div>
            ...
            <form className="flex flex-col" onSubmit={handleCreatePost}>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="border-2 hidden sm:block mt-2 w-full"
                  required
                ></textarea>
                <textarea
                  id="w3review"
