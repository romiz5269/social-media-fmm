  ...
  return (
    <div className='flex flex-row'>
      ...
      <div className="text-center  text-slate-600 font-semibold">
        <span className="mdtext-sm text-[#000] dark:text-white font-Vazirmatn">
          {profile?.followercount && numberToPersian(profile?.followercount)}
        </span>
        <span className="font-Vazirmatn mdtext-xs text-slate-500 dark:text-slate-300 font-[500] pr-1">
          دنبال کنندگان
        </span>
      </div>
